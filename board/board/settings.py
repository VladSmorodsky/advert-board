...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv("POSTGRES_PASSWORD"),  # Your database user's password
        'HOST': os.getenv("POSTGRES_HOST"),  # Use 'localhost' or the IP address of your PostgreSQL server
